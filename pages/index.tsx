...
const IndexPage = () => (
  <Layout title="Coming Soon - Clean Coming Soon Page (Tailwind CSS, NextJs & HTML5) created by themeptation.net">
    <Image
      src="/images/xera.svg"
      alt="Themeptation "
      width={500} // ajoutez la largeur de l'image ici
      height={500} // ajoutez la hauteur de l'image ici
      className="absolute h-96 -top-20 -right-16 lg:right-5 lg:top-10 animate-blob"
    />
    <Image
      src="/images/shapes.svg"
      alt="hero"
      width={1000} // ajoutez la largeur de l'image ici
      height={500} // ajoutez la hauteur de l'image ici
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link href="https://themeptation.net" passHref>
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
